...
<body style="background-color: black;">
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color:; color: white; padding: 5px;">
		<h2>CodeX Electronics</h2>
		<h6>CodeXElectronics, Your Digital Haven</h6>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>CodeX</a>
			</div>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="userHome.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>Shopping Emporia</a>
			</div>
